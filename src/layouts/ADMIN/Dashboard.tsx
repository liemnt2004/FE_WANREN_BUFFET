...
const MainDash: React.FC = () => {
    const chartConfigs: { [key: string]: { options: ApexOptions; series: any[]; type: string; height: number } } = {
        chart1: {
            options: {
                chart: {
                    type: 'line',
                            ...
                            <div className="parentContainer">
                                    ...
                                    <div className="modal-dialog modal-lg modal-dialog-centered">
                                        <div className="modal-content bg-dark text-white">
                                            <div className="modal-header">
                                                <h5 className="modal-title" id="modalSalesLabel">Sales Details</h5>
                                                <button
                                                    type="button"
                                ...
                                >
                                    <div className="modal-dialog modal-lg modal-dialog-centered">
                                        <div className="modal-content bg-dark text-white">
                                            <div className="modal-header">
                                                <h5 className="modal-title" id="modalRevenueLabel">Revenue Details</h5>
                                                <button
                                                    type="button"
                                                    className="btn-close btn-close-white"
                                                    data-bs-dismiss="modal"
                                ...
                                >
                                    <div className="modal-dialog modal-lg modal-dialog-centered">
                                        <div className="modal-content bg-dark text-white">
                                            <div className="modal-header">
                                                <h5 className="modal-title" id="modalExpensesLabel">Expenses Details</h5>
                                                <button
                                                    type="button"
                                                    className="btn-close btn-close-white"
                                                    data-bs-dismiss="modal"
