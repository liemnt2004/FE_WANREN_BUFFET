      ...
      {!editing ? (
        ...
        <div id="editPersonalInfo">
          ...
          <input
            ...
            onChange={(e) =>
              setTempInfo({ ...tempInfo, birthday: e.target.value })
            }
          />
          <hr />
          <a
        ...
        <div className="row g-0">
          ...
          <div className="col-md-10">
            <div className="product-info">
              ...
              <p>
                Are you minimalist looking for a compact carry option? The Micro
                Backpack is perfect for your essentials everyday carry items.
                Wear it like a backpack or carry it like a satchel for all day
                use.
              </p>
              <p className="delivered-info">
                <i className="fas fa-check-circle"></i> Delivered on July 12,
                2021
              </p>
              <div>
                ...
                <a href="#" className="btn btn-outline-secondary btn-buy-again">
                  Buy again
                </a>
              </div>
            </div>
          ...
          <div className="modal-body">
            <div className="row mb-3">
              <div className="col-md-4">
                <img
                  src="assets/img/tra-dao-cam-xa_1_1.jpg"
                  className="img-fluid rounded"
                  alt="Micro Backpack"
                />
              </div>
            ...
            <div className="row mb-3">
              <div className="col-md-4">
                <img
                  src="assets/img/teapop-plus-so-ri_1_1.jpg"
                  className="img-fluid rounded"
              ...
              <div className="col-md-8">
                ...
                <p>$90.00</p>
                <p>
                  This durable shopping tote is perfect for the world traveler.
                  Its yellow canvas construction is water, fray, tear-resistant.
                </p>
                <p className="delivered-info">
                  <i className="fas fa-check-circle"></i> Delivered on July 12,
                  2021
    ...
    <div className="card mb-3">
      ...
      <div className="card-body">
        ...
        <div className="row g-0">
          <div className="col-md-2 pe-3">
            <img
              src="assets/img/teapop-plus-thanh-long_1_1.jpg"
              className="img-fluid rounded"
          ...
          <div className="col-md-10">
            <div className="product-info">
              ...
              <p className="delivered-info">
                <i className="fas fa-check-circle"></i> Delivered on January 5,
                2021
              </p>
              <div>
                <a href="#" className="btn btn-outline-primary btn-product">
